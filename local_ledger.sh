...
export TOKEN_NAME="MYTH"  # Change the token name here 
export TOKEN_SYMBOL="MTH"  # Change token symbol here 
export TOKEN_IMAGE_URL="https://github.com/zaidsaid-007/MythCoin/blob/main/mythcoin_img.jpeg" 
