            ...
            <div className="row">
              <div className="col-md-6 mb-4">
                <div className="card bg-dark text-white">
                  <img src={`${process.env.PUBLIC_URL}/images/game1.jpg`} className="card-img-top" alt="Game 1" />
              ...
              <div className="col-md-6 mb-4">
                <div className="card bg-dark text-white">
                  <img src={`${process.env.PUBLIC_URL}/images/game2.jpg`} className="card-img-top" alt="Game 2" />
                  <div className="card-body">
                    <h3 className="card-title">Game 2</h3>
                    <p className="card-text">Description of Game 2</p>
                    <a href="#" className="btn btn-primary">Play</a>
                  </div>
                </div>
              </div>
        ...
        <section id="community" className="community scroll-offset">
          <div className="container text-center">
            ...
            <div class="community-links">
                  <a href="https://x.com/PullerRug73643" target="_blank" class="community-link">
                    <img src="img/twitter.jpeg" alt="Twitter Logo" class="social-logo">
                    Follow us on Twitter
                  </a>
                  <a href="https://t.me/+TRLO3bbCnRs1YTVk" target="_blank" class="community-link">
                    <img src="img/tg.jpeg" alt="Telegram Logo" class="social-logo">
                    Join our Telegram
                  </a>
                  <a href="#" target="_blank" class="community-link">
                    <img src="img/openchat.jpeg" alt="WeChat Logo" class="social-logo">
                    Connect on OpenChat
                  </a>
                </div>
          </div>
